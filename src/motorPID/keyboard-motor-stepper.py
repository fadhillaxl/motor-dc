...
def main():
    ...
    el_imu_tracker = None
    # EL tracking/control source default: motor position.
    # Aktifkan IMU-only secara eksplisit via --el-imu-only.
    enable_el_imu = args.imu and not use_sim and args.el_imu_only
